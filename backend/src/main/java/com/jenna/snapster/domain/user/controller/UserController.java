...
public class UserController {
    ...
    @PutMapping("/profile")
    public ResponseEntity<?> updateUserProfile(@CurrentUser CustomUserDetails customUserDetails,
                                               @RequestBody UserProfileUpdateDto profileUpdateDto) {
        return ResponseEntity.ok(userService.updateUserProfile(customUserDetails.getUser().getId(), profileUpdateDto));
    }
}
