...
public class ChatroomResponseDto {
    ...
    private List<ChatroomParticipantDto> participants = new ArrayList<>();

    private LocalDateTime createdAt;

    private LocalDateTime updatedAt;

    public ChatroomResponseDto(Chatroom chatroom, ChatMessage lastMessage, List<ChatroomParticipantDto> participants) {
